# Taken from https://github.com/joshua-wu/deepfakes_faceswap/blob/master/training_data.py
# We believe this github repo is closest to the original code posted by reddit user, deepfakes

import numpy
from util.image_augmentation import random_transform
from util.image_augmentation import random_warp
